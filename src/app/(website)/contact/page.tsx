...
export default function ContactPage() {
  ...
  return (
    <main className="relative min-h-screen bg-slate-950 text-white overflow-x-hidden">
      ...
      {/* 1. ATMOSPHERIC SEPARATION (Blue/Pink Glow Top-Left) */}
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
            ...
            <div className="relative rounded-[2.5rem] border border-white/8 bg-white/2 p-8 backdrop-blur-sm sm:p-12">
      ...
      {/* 3. LOCAL BUSINESS SCHEMA (JSON-LD) for SEO Boost */}
      <script
